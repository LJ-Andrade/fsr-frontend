...
@Component({
    selector: 'app-users',
    standalone: true,
    imports: [ CommonModule, CrudManagerComponent, ButtonModule, CrudFormComponent ],
...
export class Users2Component extends Crud  {
    ...
    override formFields: any[] = [
        { name: 'name', label: 'Username', value: '', placeholder: 'Enter the username', type: 'text', class: 'col-span-12',
